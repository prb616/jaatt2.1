...
class TargetFollower:
    def __init__(self):
        ...
        self.cmd_vel_pub = rospy.Publisher('/jaatt/car_cmd_switch_node/cmd', Twist2DStamped, queue_size=1)
        rospy.Subscriber('/jaatt/apriltag_detector_node/detections', AprilTagDetectionArray, self.tag_callback, queue_size=1)
